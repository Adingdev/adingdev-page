...
<!--le header de mon site-->
    ...
    <section class="banner" id="banner">
        <div class="contener">
            <h2>Welcome to the web dev</h2>
            <p class="texte"> Front-end and Back-end devepper  </p>
            <a href="#developpeur" class="btn1"> Me Contacter</a>
            <a href="#" class="btn2">Nos formations</a>
        </div>
        <div>
            <div><i class="fas fa-whatsapp fa-3x"></i></div>
        </div>
<div class="souscrure">
    <label for="text">Abonnez-vous a ma page web</label>
    <input type="text" name="value" id="inform" placeholder="Exemple:Adingrakouassijeanpaul55@gmail.com" class="informe"/>
    <button class="butform">souscribe</button>
</div>
    </section>
    ...
    <section class="contacter" id="contacter">
        ...
        <div class="forme">
            <form action="#" method="GET" class="formulaire">
                ...
                <input type="password" class="inputf" id="mot de pass" placeholder="password" required="password">
                <input type="email" name="e-mail" class="inputf" id="e-mail" placeholder="email" required="email">
                <textarea name="commentaire" id=""placeholder="votre commentaire"></textarea>
